...
<body>
    <div class="container">
        ...
        <form id="loginForm">
            ...
            <div id="verif">
                ...
                <button onclick="verificarRespuesta(event)" data-translate="verif">Réponse....</button>
            </div>
            <p id="resultado"></p>
            
            <div id="bot" style="display: none">
                    <button type="button" onclick="iniciarSesion()" id="btnEnviar" disabled>Réinitialisation du mot de passe</button>
    ...
    if (email.trim() !== '') {
        ...
        xhr.open('POST', './PHP/recovery.php', true);
